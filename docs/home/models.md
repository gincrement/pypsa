...
- **[:flag_at: PyPSA-AT](https://github.com/centrefornetzero/pypsa-fes)**: Great Britain power system model, maintained by [Austrian Gas Grid Management AG (AGGM)](https://github.com/AGGM-AG/pypsa-at)
